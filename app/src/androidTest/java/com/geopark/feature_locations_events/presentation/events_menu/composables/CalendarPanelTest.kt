...
class CalendarPanelTest {
    ...
    @Test
    fun calendarDataAreSameAsState(){
        resetCalendarState()
        ...
        composeTestRule.onNodeWithContentDescription("Selected month").assertTextEquals("${state.value.month}, ${state.value.year}")

        composeTestRule.onNodeWithContentDescription("Next month").assertIsDisplayed().performClick()
        composeTestRule.onNodeWithContentDescription("Selected month").assertTextEquals("${state.value.month}, ${state.value.year}")

        composeTestRule.onNodeWithContentDescription("Previous month").assertIsDisplayed().performClick()
        composeTestRule.onNodeWithContentDescription("Selected month").assertTextEquals("${state.value.month}, ${state.value.year}")
